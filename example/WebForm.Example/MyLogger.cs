...
namespace WebForm.Example
{
    public class MyLogger
    {
        ...
        /// <returns></returns>
        public static async Task AddLog(HttpContext context, LogLevel level, string message = null, string remark = null)
        {
        ...
        /// <returns></returns>
        public static async Task AddStatisticLog(HttpContext context, StatisticAction action, string message = null)
        {
